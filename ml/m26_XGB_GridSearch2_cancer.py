...
# model = SVC()
model = GridSearchCV(XGBClassifier(n_jobs=2,use_label_encoder=False) , parameters, cv=kfold)
...
'''
best parameter :  XGBClassifier(base_score=0.5, booster='gbtree', colsample_bylevel=0.6,
