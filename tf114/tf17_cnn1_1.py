...
#L1.
w1 = tf.get_variable('w1', shape = [3, 3, 1, 128])       # 3,3 => 커널사이즈 1 => 흑백, 32 => filter
...
#L5.
w5 = tf.get_variable('w5', shape = [2*2*32, 64], initializer=tf.initializers.he_normal())
...
#L6.
w6 = tf.get_variable('w6', shape = [64, 32], initializer=tf.initializers.he_normal())
...
#L7.
w7 = tf.get_variable('w7', shape = [32, 10], initializer=tf.initializers.he_normal())
