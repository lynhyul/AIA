...
train_generator = idg.flow(x_train,y_train,batch_size=128, seed = 2048)
# seed => random_state
valid_generator = idg2.flow(x_valid,y_valid)
test_generator = idg2.flow(x_pred, shuffle=False)

mc = ModelCheckpoint('../../data/modelcheckpoint/lotte_projcet12.h5',save_best_only=True, verbose=1)
...
# predict
model.load_weights('../../data/modelcheckpoint/lotte_projcet12.h5')
...
sub.to_csv('../../data/image/answer12.csv',index=False)
