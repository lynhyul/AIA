...
mc = ModelCheckpoint('../../data/modelcheckpoint/lotte_projcet15.h5',save_best_only=True, verbose=1)
...
a = Dense(128, activation= 'swish') (a)
...
model.compile(loss='categorical_crossentropy', optimizer=Adam(learning_rate=2e-3),
                metrics=['acc'])
# learning_history = model.fit_generator(train_generator,epochs=80, steps_per_epoch= len(x_train) / 64,
#     validation_data=valid_generator, callbacks=[early_stopping,lr,mc])

# predict
model.load_weights('../../data/modelcheckpoint/lotte_projcet15.h5')
