...
train_data = pd.read_csv('../data/csv/practice/train.csv')
test_data = pd.read_csv('../data/csv/practice/test.csv')
...
print(digit_ref[digit_ref != 0].shape)
