...
x_train =np.load('../data/npy/FashionMnist_x_train.npy')
y_train = np.load('../data/npy/FashionMnist_y_train.npy')
x_test = np.load('../data/npy/FashionMnist_x_test.npy')
y_test = np.load('../data/npy/FashionMnist_y_test.npy')
