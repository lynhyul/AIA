...
# LSTM으로 해봐라..
# input_shape = (28*28,1)
# input_shape = (28*14,2) 으로 응용가능
# input_shape = (28*7,4) 으로 응용가능
# input_shape = (7*7,16) 으로 응용가능
...
x_train = x_train.reshape(60000,7*7,16).astype('float32')/255.         # 이미지의 전처리 (max값이 255기때문에 255로 나눠서
                                                                                            #0~1 사이로 만듦)
...
model.add(LSTM(310, activation='relu', input_shape=(7*7,16)))
