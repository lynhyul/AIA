...
# model.add(Dense(5))   # name : dense
# model.add(Dense(1))   # name : dense_1
model.add(Dense(5,name='kingkeras1'))
model.add(Dense(1,name='kingkeras2'))
'''
All layers added to a Sequential model should have unique names.
 Name "dense" is already the name of a layer in this model. Update the 
 `name` argument to pass a unique name.
'''
...
'''
[0.0013572272146120667, 0.028465429320931435]
[[11.044353]]
